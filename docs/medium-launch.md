# I shipped a video player to npm — twice. Here's what I learned about scoped CSS, "use client", and Nuxt modules.
...
Both are at v1.0.1 today. Both are MIT. Both have the same prop surface, same UI, and ship under 4 KB gzipped of CSS + JS.
...
```css
:root, :host { --color-violet-700: ...; --font-sans: ui-sans-serif, system-ui, ...; ... }
